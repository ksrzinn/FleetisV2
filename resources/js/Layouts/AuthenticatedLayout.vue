        ...
        navItems() {
            return [
                ...
                },
                {
                    ...
                    match: 'fuel-records.*',
                    icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 7.5l16.5-4.125M12 6.75c-2.708 0-4.5.895-4.5 2.25s1.792 2.25 4.5 2.25 4.5-.895 4.5-2.25-1.792-2.25-4.5-2.25zm0 0v9m-4.5 0c0 1.243 1.792 2.25 4.5 2.25s4.5-1.007 4.5-2.25m-9 0V9m9 6.75V9" />`,
                },
                {
                    label: 'Manutenções',
