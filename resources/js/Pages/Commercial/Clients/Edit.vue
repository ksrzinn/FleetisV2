...
export default {
    ...
    setup(props) {
        const form = useForm({
            ...
            payment_term_type: props.client.payment_term_type ?? null,
            payment_term_value: props.client.payment_term_value ?? null,
        })
        return { form }
    },
            ...
            <form @submit.prevent="submit">
                <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-200">
                    <div class="p-6 space-y-6">
                        ...
                        <!-- Payment terms -->
                        <div>
                            <h2 class="mb-4 text-sm font-semibold text-gray-700">Condições de Pagamento</h2>
                            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                <div>
